...
// /invite/* isn't listed here because it's not in the matcher below —
// invite pages are meant to be reachable by anonymous visitors and
// handle their own auth state server-side, so they never need to pass
